...
function OnboardingScreen({ shops, onComplete, onJoinShop, pushToast, initialMode, onCancel }) {
  ...
  const next = async () => {
    ...
    try {
      ...
      pushToast(e.message.startsWith("OFFLINE") ? "Connexion internet requise pour créer une boutique." : "Erreur lors de la création, réessayez.", "error");
    } finally {
      setLoading(false);
    }
  };
  ...
  const submitJoin = async () => {
    ...
    try {
      ...
      pushToast(e.message.startsWith("OFFLINE") ? "Connexion internet requise pour rejoindre une boutique." : (e.message || "Code introuvable"), "error");
    } finally {
      setLoading(false);
    }
  };
  ...
  const submitReconnect = async () => {
    ...
    try {
      ...
      pushToast(e.message.startsWith("OFFLINE") ? "Connexion internet requise pour se reconnecter." : (e.message || "Reconnexion impossible"), "error");
    } finally {
      setLoading(false);
    }
  };
