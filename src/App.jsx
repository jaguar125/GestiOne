...
const GESTIONE_ICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" width="100%" height="100%" role="img" aria-labelledby="iconTitle">
...
function GestiOneIcon({ size = 76 }) {
  return (
    <div
      style={{ width: size, height: size, minWidth: size, minHeight: size, filter: "drop-shadow(0 6px 16px rgba(0,0,0,0.25))", display: "inline-block", lineHeight: 0, overflow: "hidden" }}
  ...
  if (mode === "reconnect") {
    if (!reconnectRole) {
      return (
        <div className="min-h-full flex flex-col items-center justify-center px-6 py-10" style={{ background: "var(--glass)" }}>
          <div className="mb-8 text-center gb-slide-up">
            <div className="mx-auto mb-4" style={{ width: 56, height: 56 }}><GestiOneIcon size={56} /></div>
...
function SupplierOrdersModal({ supplier, ordersForSupplier, onNewOrder, onOpenOrder, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex no-print">
      <div className="relative w-full h-full overflow-y-auto gb-scroll p-5" style={{ background: "var(--card)" }}>
        <div className="flex items-center justify-between mb-4">
