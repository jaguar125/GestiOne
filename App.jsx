...
function GestiOneIcon({ size = 76 }) {
  return (
    <div
      style={{ width: size, height: size, filter: "drop-shadow(0 6px 16px rgba(0,0,0,0.25))", display: "inline-block", lineHeight: 0 }}
      dangerouslySetInnerHTML={{ __html: GESTIONE_ICON_SVG.replace('width="76" height="76"', 'width="100%" height="100%"') }}
    />
  );
}
